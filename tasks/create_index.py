...
""" def create_new_gazettes_index(index: IndexInterface) -> None:
    body = {
        "mappings": {
            "properties": {
            "created_at": {"type": "date"},
            ...
            "source_text": {
                "type": "text",
                "analyzer": "brazilian",
                # Adicionando um search_analyzer para fazer buscas com multi-match
                ...
                "with_stopwords": {
                    ...
                    "analyzer": "brazilian_with_stopwords",
                    # Adicionando um search_analyzer para fazer buscas com multi-match
                    "search_analyzer": "brazilian_with_stopwords",
                    "index_options": "offsets",
                    "term_vector": "with_positions_offsets",
                },
                "exact": {
