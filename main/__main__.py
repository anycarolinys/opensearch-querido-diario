...
from tasks import (
    ...
    extract_text_from_gazettes_in_batches,
...
def execute_pipeline():
    ...
    """ indexed_gazette_ids = extract_text_from_gazettes_in_batches(
        gazettes_to_be_processed, territories, database, storage, index, text_extractor, 10
    ) """
   
    """ comentar para nao trabalhar com os indices tematicos """
    """ for theme in themes:
